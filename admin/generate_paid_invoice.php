...
?>
   ...
   <!--         <div class="callout callout-info">
            ...
            foreach($qry->fetch_array() as $k => $val){
                ...
                <div class="col-sm-4 invoice-col">
                  To : <strong>
                      <?php echo  $customaername ?></strong><br>
                  <address>
	...
	<tr>
          <td colspan="5">ORDER OF ROOM NO : <?php echo $row1[roomno] ?> || DATE : <?php echo $row1[timeoforder] ?> </td>
              ...
              <a href="index.php?page=thermal_printer&id=<?php echo $_GET['id'] ?>"  rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Thermal  Printer </a> 
