...
[{"id":6,"item_name":"Chicken+Sweet+Corn+Soup","item_price":200,"extras":{},"quantity":5}
,{"id":9,"item_name":"Momo","item_price":50,"extras":{},"quantity":4}]
...
<head>
    <title> Hotel Taj - WeCode Future QR Menu</title>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="https://qr.wecodefuture.com/storage/logo/favicon.png">
    ...
    <script async>
        ...
        var mapcolor = '#8080ff';
        var siteurl = 'https://qr.wecodefuture.com/';
        var template_name = 'restro-theme';
        var ajaxurl = "https://qr.wecodefuture.com/php/931a4ast5j.php";
    </script>
    <style>
...
<div id="content">
    ...
    <div class="content-wrap">
        <div class="single-page-header detail-header" data-background-image="https://qr.wecodefuture.com/storage/restaurant/cover/1633410109615bdc3dae601.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="single-page-header-inner">
                            <div class="left-side">
                                <div class="header-image"><img src="https://qr.wecodefuture.com/storage/restaurant/logo/1633410108615bdc3c71bfe.jpg"></div>
                                <div class="header-details">
                                    <h3>Hotel Taj<span>Good food and great vibes.</span></h3>
                                    <ul>
                                         <li><i class="icon-feather-watch margin-right-5"></i> Monday to Sunday : 12 P.M to 11 P.M.</li>                                        <li><i class="icon-feather-map margin-right-5"></i> <a target="_blank" href="https://www.google.com/maps/search/?api=1&amp;query=P-183, CIT Scheme, VII(M), Kol-700054">P-183, CIT Scheme, VII(M), Kol-700054</a></li>
                                                                            </ul>
                                </div>
                            </div>
                        </div>
...
while($row1 = mysqli_fetch_array($data1))
{
    ...
    ?>
             ...
             <div class="card-body menu-category-item menu-category-<?php echo $row1['fcid'];?> ">
                ...
                <div class="section-menu" data-id="<?php echo $row1['id'];?>" data-name="<?php echo $row1['food_name'];?>" data-price=" &#8377; <?php echo $row1['price'];?>;" data-amount="<?php echo $row1['price'];?>" data-description="<?php echo $row1['description'];?>" data-image-url="menu/<?php echo $row1['photo'];?>">
                        <div class="menu-item list">
                        <div class="menu-image">
                                    <img src="https://qr.wecodefuture.com/storage/menu/1633410504615bddc87fa6b.jpg">
                                    <div class="badge abs <?php echo $row1['type'];?>"><i class="fa fa-circle"></i></div>
                                </div> 
                            <div class="menu-content">
                                <div class="menu-detail">
                                    <div class="menu-title">
                                        <h4><?php echo $row1['food_name'];?></h4>
                                        <div class="menu-price"> &#8377; <?php echo $row1['price'];?></div>
                                ...
                                <div class="menu-recipe"><?php echo $row1['description'];?></div>
                            </div>
    ...
    <div class="your-order-content">
            ...
            <div class="section3">
                ...
                <div class="form-group">
                    <div class="form-line">
                        ...
                        <div class="section">
                <div class="col-text font-medium my-2">Ordering For</div>
                <div class="form-group">
                    <div class="form-line">
        ...
        <div class="footer footer-extras">
            ...
            <div class="section">
                ...
                <button type="submit" class="btn btn-primary btn-block" id="submit-order-button">Send Order</button>
            </div>
        </div>
        <!-- Bottom Panel  -->
                    </form>
...
<script>
    var TOTAL_MENUS = {"6":{"id":"6","title":"Chicken Sweet Corn Soup","price":"200","type":"nonveg","description":"Garnished with a sweet and sour items for best taste.","extras":[]},"9":{"id":"9","title":"Momo","price":"50","type":"nonveg","description":"Chicken Momo","extras":[]},"10":{"id":"10","title":"French Fries","price":"90","type":"veg","description":"Fried Potato&#039;s with extra cheesy Dip sauce","extras":[]},"7":{"id":"7","title":"Soft Drinks","price":"150","type":"veg","description":"With extra Ice and blended with suger","extras":[]},"8":{"id":"8","title":"Biriyani","price":"300","type":"nonveg","description":"Extra mutton biriyani for best taste","extras":[]}};
    var CURRENCY_SIGN = '&#8377;';
    var CURRENCY_LEFT = 0;
