...
<head>
    ...
    <script async>
        ...
        var mapcolor = '#8080ff';
        var siteurl = 'https://wekartlab.in/ADDONS/HOTELDEMO';
        var template_name = 'restro-theme';
        var ajaxurl = "https://wekartlab.in/ADDONS/HOTELDEMO/orderaccess.php";
    </script>
    <style>
...
<nav class="navbar navbar-expand-lg navbar-light bg-header">
    <div class="container-fluid flex-nowrap">
     ...
     <a href="trackorder.php?room=<?php echo $decrypted; ?>"    <button type="button" class="btn btn-default ml-auto mr-1" id="call-the-waiter-btn" title="Call the Waiter">
            <i class="fa fa-map-marker"></i>
            <span class="d-sm-inline">Trak Your Order</span>
        </button> </a>
                        ...
                        <div class="single-page-header-inner">
                            <div class="left-side">
                                ...
                                <div class="header-details">
                                    <h3><?php echo $name ?> - Room Number : <?=$decrypted;?><span>Good food and great vibes.</span></h3>
                                    <ul>
             ...
             <div class="card-body menu-category-item menu-category-<?php echo $row1['fcid'];?> ">
                ...
                <div class="section-menu" data-id="<?=$row1['id'];?>" data-name="<?=$row1['title'];?>" data-price="<?=$row1['price'];?> &#8377;" data-amount="<?=$row1['price'];?>" data-description="<?=$row1['description'];?>" data-image-url="menu/<?=$row1['photo'];?>">
                        ...
                        <div class="menu-image">
                                    ...
                                    <div class="badge abs <?=$row1['type'];?>"><i class="fa fa-circle"></i></div>
                                </div> 
